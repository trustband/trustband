...
## Hard requirements
- [x] ≥3 specialized agents collaborating through the bus (Planner, Coder, Verifier, Reviewer + human gate)
- [x] Structured context exchange (typed Pydantic artifacts handed off in the room)
